...
<!--		Dynamic grabbing of posts from the database-->
    ...
    if (mysqli_connect_errno()){
        ...
        $stmt = $connection->prepare("SELECT * FROM posts WHERE db_post_title LIKE '%".$search_key."%' OR db_post_content LIKE '%".$search_key."%'")or die(mysqli_error());
        $stmt->execute();
...
//        $query = mysqli_query($connection, "SELECT * FROM posts WHERE db_post_title LIKE '%".$search_key."%' OR db_post_content LIKE '%".$search_key."%'") or die(mysqli_error());
//            
//            
